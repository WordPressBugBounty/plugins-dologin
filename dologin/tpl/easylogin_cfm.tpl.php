...
<head>
	...
	<title><?php esc_html_e( 'DoLogin Easy Login Notice', 'dologin' ); ?></title>
</head>
...
<main style="max-width:520px;margin:60px auto;padding:24px;background:#fff;border:1px solid #dcdcde;border-radius:8px;text-align:center;">
	<h1 style="margin:0 0 16px;font-size:1.3em;"><?php esc_html_e( 'DoLogin Easy Login Notice', 'dologin' ); ?></h1>
	<p style="margin:0 0 4px;"><?php esc_html_e( 'You will login as the following user', 'dologin' ); ?>:</p>
	<p style="margin:0;font-size:1.2em;font-weight:600;color:#1a7f37;"><?php echo esc_html( $user_info->user_login ); ?></p>
	<p style="margin:16px 0 4px;"><?php esc_html_e( 'to the site:', 'dologin' ); ?></p>
	<p style="margin:0;font-size:1.2em;font-weight:600;color:#1a7f37;word-break:break-all;"><?php echo esc_url( site_url() ); ?></p>
