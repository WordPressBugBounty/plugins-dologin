...
class Captcha extends Instance
{
	...
	{
		wp_register_script('dologin_google_api', 'https://www.google.com/recaptcha/api.js?render=' . Conf::val('gg_pub_key'), array(), null);
		...
		document.addEventListener('DOMContentLoaded', function() {
			...
			form.addEventListener('submit', function(e) {
				...
				grecaptcha.ready(function() {
					grecaptcha.execute('" . Conf::val('gg_pub_key') . "', {action: 'submit'}).then(function(token) {
						// console.log(token);
